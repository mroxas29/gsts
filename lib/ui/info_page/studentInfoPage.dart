                              ...
                              onConfirm: (bool isAccepted) async {
                                if (isAccepted) {
                                  ...
                                  Timeline newTimeline = Timeline(
                                    ...
                                    type: "Application",
                                    description:
                                        "Student has been accepted on ${getCurrentSYandTerm()}",
                                  );
                                  addTimelineEvent(
                                      widget.student.uid, newTimeline);
                                } else {
                          ...
                          cells: [
                            ...
                            DataCell(
                              TextButton(
                                onPressed: () async {
                                  String fileName =
                                      '${widget.student.idnumber}/Defense Forms/Official_Receipt_${widget.student.displayname['lastname']}_${widget.student.displayname['firstname']}.pdf';
                                  try {
